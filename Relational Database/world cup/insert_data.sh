...
#get current line and unpack CSV
cat games.csv | while IFS="," read YEAR ROUND WINNER OPPONENT WINNER_GOALS OPPONENT_GOALS
do
  #if current line is not the header
  if [[ $WINNER != 'winner' ]]
  then
    ...
    if [[ -z $WINNER_ID ]]
    then
      #make team_id of winner if it doesn't exist
    ...
    #make team_id of opponent if it doesn't exist
    if [[ -z $OPPONENT_ID ]]
    then
      #make team_id of winner if it doesn't exist
